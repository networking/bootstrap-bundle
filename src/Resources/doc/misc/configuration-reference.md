...
Default configuration for extension with alias: "networking_bootstrap"

```yaml
networking_bootstrap:
    form:
        templating:           @NetworkingBootstrap/Form/fields.html.twig
        # Default form layout
    ...
    icons:
        ...
        # Alias for networking_bootstrap_icon()
        shortcut:             icon
    menu:
        enabled:              false

        # Menu template to use when rendering
        template:             @NetworkingBootstrap/Menu/menu.html.twig
    initializr:
        meta:
